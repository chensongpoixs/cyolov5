...
path = r'D:/Work/cartificial_intelligence/datasets/CCPD2020/ccpd_green/test/images'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"D:/Work/cartificial_intelligence/datasets/CCPD2020/ccpd_green/test/result_images/{}.jpg".format(result))
    # 图片中文名会报错
